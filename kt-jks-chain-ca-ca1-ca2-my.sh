...
AUTHORITY_STORE=st-ca-keystore.jks
KEY_STORE=st-svr-keystore.jks
TRUST_STORE=st-svr-truststore.jks
...
keytool -exportcert -alias ca                                                   \
        -keystore ${KEY_STORE} -keypass ${KEY_PASS} -storepass ${STORE_PASS}       \
| keytool   -importcert -trustcacerts -noprompt -alias ca                       \
            -keystore ${TRUST_STORE} -keypass ${KEY_PASS} -storepass ${STORE_PASS}
